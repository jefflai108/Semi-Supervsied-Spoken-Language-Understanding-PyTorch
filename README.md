...
**update** The implementation of our end-to-end slot-filling will be merged into one of the downstream tasks in the [S3PRL toolkit](https://github.com/s3prl/s3prl). Stay tuned!
