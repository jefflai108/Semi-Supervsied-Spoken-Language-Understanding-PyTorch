...
**UPDATE: Our end-to-end slot-filling model will be implemented as one of the downstream tasks in the [S3PRL toolkit](https://github.com/s3prl/s3prl). Stay tuned!**
